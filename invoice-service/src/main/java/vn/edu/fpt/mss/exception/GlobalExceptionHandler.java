...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleFeignNotFound(feign.FeignException.NotFound ex) {
        return build(HttpStatus.NOT_FOUND, "Target resource not found in external service");
    }

    @ExceptionHandler(feign.FeignException.class)
    public ResponseEntity<Map<String, Object>> handleFeignException(feign.FeignException ex) {
        return build(HttpStatus.SERVICE_UNAVAILABLE, "External service communication error: " + ex.getMessage());
    }
