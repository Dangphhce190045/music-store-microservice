...
@Tag(name = "Customers", description = "CRUD operations for customers and CRM support")
public class CustomerController {

    private final CustomerService customerService;

    @GetMapping
    @Operation(summary = "Get all customers, optionally filtered by supportRepId")
    public List<CustomerResponse> findAll(@RequestParam(required = false) Integer supportRepId) {
        return supportRepId == null ? customerService.findAll() : customerService.findBySupportRep(supportRepId);
    }
